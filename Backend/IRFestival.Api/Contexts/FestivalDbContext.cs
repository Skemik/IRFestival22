...
namespace IRFestival.Api.Contexts
{
    public class FestivalDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ScheduleItem>().HasData(new ScheduleItem { Id = 1,ScheduleId = lineUp.Id,ArtistId = artists[0].Id, StageId = stages[0].Id, Time = new DateTime(1972, 07, 01, 20, 0, 0) });
            modelBuilder.Entity<ScheduleItem>().HasData(new ScheduleItem { Id = 2, ScheduleId = lineUp.Id, ArtistId = artists[4].Id, StageId = stages[3].Id, Time = new DateTime(1972, 07, 01, 20, 30, 0) });
            ...
            modelBuilder.Entity<ScheduleItem>().HasData(new ScheduleItem { Id = 6, ScheduleId = lineUp.Id, ArtistId = artists[4].Id, StageId = stages[3].Id, Time = new DateTime(1972, 07, 02, 20, 45, 0) });
            modelBuilder.Entity<ScheduleItem>().HasData(new ScheduleItem { Id = 7, ScheduleId = lineUp.Id, ArtistId = artists[3].Id, StageId = stages[0].Id, Time = new DateTime(1972, 07, 02, 22, 0, 0) });
            modelBuilder.Entity<ScheduleItem>().HasData(new ScheduleItem { Id = 8, ScheduleId = lineUp.Id, ArtistId = artists[1].Id, StageId = stages[1].Id, Time = new DateTime(1972, 07, 02, 22, 30, 0) });
